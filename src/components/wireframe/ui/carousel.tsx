...
export interface CarouselComponentProps
  extends React.ComponentProps<"div">, CarouselProps {}
...
function CarouselContent({ className, ...props }: CarouselContentProps) {
  ...
  return (
    <div
      ...
      data-slot="wireframe-carousel-content"
    >
      <div
        className={cn(
          "flex",
...
function CarouselItem({ className, ...props }: CarouselItemProps) {
  ...
  return (
    <div
      ...
      data-slot="wireframe-carousel-item"
      className={cn(
...
function CarouselPrevious({
  ...
  return (
    <Button
      data-slot="wireframe-carousel-previous"
      variant={variant}
      size={size}
      className={cn(
...
function CarouselNext({
  ...
  return (
    <Button
      data-slot="wireframe-carousel-next"
      variant={variant}
      size={size}
      className={cn(
        "absolute size-8 rounded-full",
