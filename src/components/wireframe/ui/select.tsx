...
function Select({ ...props }: SelectProps) {
  return <SelectPrimitive.Root data-slot="wireframe-select" {...props} />;
}
...
function SelectGroup({ ...props }: SelectGroupProps) {
  return (
    <SelectPrimitive.Group data-slot="wireframe-select-group" {...props} />
  );
}
...
function SelectValue({
  ...
  return (
    <SelectPrimitive.Value
      data-slot="wireframe-select-value"
...
function SelectTrigger({
  ...
  return (
    <SelectPrimitive.Trigger
      data-slot="wireframe-select-trigger"
      data-size={size}
      className={cn(
        "border-input data-[placeholder]:text-muted-foreground [&_svg:not([class*='text-'])]:text-muted-foreground focus-visible:border-ring focus-visible:ring-ring/50 aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive dark:bg-input/30 dark:hover:bg-input/50 flex w-fit items-center justify-between gap-2 rounded-md border bg-transparent px-3 py-2 text-sm whitespace-nowrap shadow-xs transition-[color,box-shadow] outline-none focus-visible:ring-[3px] disabled:cursor-not-allowed disabled:opacity-50 data-[size=default]:h-9 data-[size=sm]:h-8 *:data-[slot=wireframe-select-value]:line-clamp-1 *:data-[slot=wireframe-select-value]:flex *:data-[slot=wireframe-select-value]:items-center *:data-[slot=wireframe-select-value]:gap-2 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4",
        className
      )}
      {...props}
    >
  ...
  return (
    <SelectPrimitive.Portal>
      <SelectPrimitive.Content
        data-slot="wireframe-select-content"
        className={cn(
...
function SelectLabel({ className, ...props }: SelectLabelProps) {
  return (
    <SelectPrimitive.Label
      data-slot="wireframe-select-label"
...
function SelectItem({ className, children, ...props }: SelectItemProps) {
  return (
    <SelectPrimitive.Item
      data-slot="wireframe-select-item"
      className={cn(
...
function SelectSeparator({ className, ...props }: SelectSeparatorProps) {
  return (
    <SelectPrimitive.Separator
      data-slot="wireframe-select-separator"
...
function SelectScrollUpButton({
  ...
  return (
    <SelectPrimitive.ScrollUpButton
      data-slot="wireframe-select-scroll-up-button"
      className={cn(
...
function SelectScrollDownButton({
  ...
  return (
    <SelectPrimitive.ScrollDownButton
      data-slot="wireframe-select-scroll-down-button"
      className={cn(
        "flex cursor-default items-center justify-center py-1",
        className
      )}
