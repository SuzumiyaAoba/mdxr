...
function Breadcrumb({ ...props }: BreadcrumbProps) {
  return (
    <nav aria-label="breadcrumb" data-slot="wireframe-breadcrumb" {...props} />
  );
}
...
function BreadcrumbList({ className, ...props }: BreadcrumbListProps) {
  return (
    <ol
      data-slot="wireframe-breadcrumb-list"
      className={cn(
...
function BreadcrumbItem({ className, ...props }: BreadcrumbItemProps) {
  return (
    <li
      data-slot="wireframe-breadcrumb-item"
...
function BreadcrumbLink({ asChild, className, ...props }: BreadcrumbLinkProps) {
  ...
  return (
    <Comp
      data-slot="wireframe-breadcrumb-link"
...
function BreadcrumbPage({ className, ...props }: BreadcrumbPageProps) {
  return (
    <span
      data-slot="wireframe-breadcrumb-page"
      aria-current="page"
...
function BreadcrumbSeparator({
  ...
  return (
    <li
      data-slot="wireframe-breadcrumb-separator"
      role="presentation"
      aria-hidden="true"
...
function BreadcrumbEllipsis({ className, ...props }: BreadcrumbEllipsisProps) {
  return (
    <span
      data-slot="wireframe-breadcrumb-ellipsis"
      role="presentation"
      aria-hidden="true"
