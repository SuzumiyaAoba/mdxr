...
export const Details = defineComponent(
  ...
  ({ summary, open, children }) => {
    ...
    return (
      <details
        className="rv-details my-4 rounded-lg border border-neutral-200 dark:border-neutral-800"
        open={isOpen}
      >
        <summary className="flex cursor-pointer items-center gap-2 rounded-lg px-4 py-2.5 text-sm font-medium text-neutral-700 transition-colors select-none hover:bg-neutral-50 dark:text-neutral-200 dark:hover:bg-neutral-900">
          <Icon
