...
<iframe src={`${import.meta.env.BASE_URL}/components/scaffolding.src.html`} title="scaffolding.mdx source" loading="lazy" style="width:100%;height:480px;border:1px solid #d4d4d8;border-radius:8px;background:#fff" />
...
<iframe src={`${import.meta.env.BASE_URL}/components/planning.src.html`} title="planning.mdx source" loading="lazy" style="width:100%;height:480px;border:1px solid #d4d4d8;border-radius:8px;background:#fff" />
...
<iframe src={`${import.meta.env.BASE_URL}/components/investigation.src.html`} title="investigation.mdx source" loading="lazy" style="width:100%;height:480px;border:1px solid #d4d4d8;border-radius:8px;background:#fff" />
...
<iframe src={`${import.meta.env.BASE_URL}/components/artifacts.src.html`} title="artifacts.mdx source" loading="lazy" style="width:100%;height:480px;border:1px solid #d4d4d8;border-radius:8px;background:#fff" />
...
<iframe src={`${import.meta.env.BASE_URL}/components/reports.src.html`} title="reports.mdx source" loading="lazy" style="width:100%;height:480px;border:1px solid #d4d4d8;border-radius:8px;background:#fff" />
...
<iframe src={`${import.meta.env.BASE_URL}/components/charts.src.html`} title="charts.mdx source" loading="lazy" style="width:100%;height:480px;border:1px solid #d4d4d8;border-radius:8px;background:#fff" />
...
<iframe src={`${import.meta.env.BASE_URL}/components/layout.src.html`} title="layout.mdx source" loading="lazy" style="width:100%;height:480px;border:1px solid #d4d4d8;border-radius:8px;background:#fff" />
...
<iframe src={`${import.meta.env.BASE_URL}/components/shadcn.src.html`} title="shadcn.mdx source" loading="lazy" style="width:100%;height:480px;border:1px solid #d4d4d8;border-radius:8px;background:#fff" />
...
<iframe src={`${import.meta.env.BASE_URL}/components/custom.src.html`} title="custom.mdx source" loading="lazy" style="width:100%;height:480px;border:1px solid #d4d4d8;border-radius:8px;background:#fff" />
