...
function TooltipProvider({
  ...
  return (
    <TooltipPrimitive.Provider
      data-slot="wireframe-tooltip-provider"
...
function Tooltip({ ...props }: TooltipProps) {
  return (
    <TooltipProvider>
      <TooltipPrimitive.Root data-slot="wireframe-tooltip" {...props} />
    </TooltipProvider>
  );
}
...
function TooltipTrigger({ ...props }: TooltipTriggerProps) {
  return (
    <TooltipPrimitive.Trigger
      data-slot="wireframe-tooltip-trigger"
      {...props}
    />
  );
}
  ...
  return (
    <TooltipPrimitive.Portal>
      <TooltipPrimitive.Content
        data-slot="wireframe-tooltip-content"
    ...
    <Tooltip>
      <TooltipTrigger asChild>
        <Button variant="outline">
          {triggerIcon || (
            <QuestionMarkCircleIcon className="text-muted-foreground size-5" />
          )}
          <Text width="xs" />
        </Button>
      </TooltipTrigger>
