...
function Card({ className, wireframe = "none", ...props }: CardProps) {
  const contextValue = React.useMemo(() => ({ wireframe }), [wireframe]);
  ...
  return (
    <CardContext.Provider value={contextValue}>
      <div
        data-slot="wireframe-card"
        className={cn(
          "not-prose bg-card text-card-foreground flex min-w-0 flex-col rounded-xl border shadow-sm",
...
function CardHeader({ className, ...props }: CardHeaderProps) {
  ...
  return (
    <div
      data-slot="wireframe-card-header"
      className={cn(
        "@container/card-header grid min-w-0 auto-rows-min grid-cols-[minmax(0,1fr)] grid-rows-[auto_auto] items-start has-data-[slot=wireframe-card-action]:grid-cols-[minmax(0,1fr)_auto]",
...
function CardTitle({ className, ...props }: CardTitleProps) {
  return (
    <div
      data-slot="wireframe-card-title"
...
function CardDescription({ className, ...props }: CardDescriptionProps) {
  return (
    <div
      data-slot="wireframe-card-description"
...
function CardAction({ className, ...props }: CardActionProps) {
  return (
    <div
      data-slot="wireframe-card-action"
      className={cn(
...
function CardContent({ className, ...props }: CardContentProps) {
  ...
  return (
    <div
      data-slot="wireframe-card-content"
...
function CardFooter({ className, ...props }: CardFooterProps) {
  ...
  return (
    <div
      data-slot="wireframe-card-footer"
      className={cn(
        "flex items-center",
        wireframePadding[wireframe],
        className
