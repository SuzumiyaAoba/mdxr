...
function Drawer(props: DrawerProps) {
  return <DrawerPrimitive.Root data-slot="wireframe-drawer" {...props} />;
}
 ...
 */
export interface DrawerTriggerProps extends React.ComponentProps<
  typeof DrawerPrimitive.Trigger
> {}

function DrawerTrigger({ ...props }: DrawerTriggerProps) {
  return (
    <DrawerPrimitive.Trigger data-slot="wireframe-drawer-trigger" {...props} />
  );
}
...
function DrawerPortal({ ...props }: DrawerPortalProps) {
  return (
    <DrawerPrimitive.Portal data-slot="wireframe-drawer-portal" {...props} />
  );
}

export interface DrawerCloseProps extends React.ComponentProps<
  typeof DrawerPrimitive.Close
> {}

function DrawerClose({ ...props }: DrawerCloseProps) {
  return (
    <DrawerPrimitive.Close data-slot="wireframe-drawer-close" {...props} />
  );
}

export interface DrawerOverlayProps extends React.ComponentProps<
...
function DrawerOverlay({ className, ...props }: DrawerOverlayProps) {
  return (
    <DrawerPrimitive.Overlay
      data-slot="wireframe-drawer-overlay"
      className={cn(
...
function DrawerContent({ className, children, ...props }: DrawerContentProps) {
  return (
    <DrawerPortal data-slot="wireframe-drawer-portal">
      <DrawerOverlay />
      <DrawerPrimitive.Content
        data-slot="wireframe-drawer-content"
        className={cn(
...
function DrawerHeader({ className, ...props }: DrawerHeaderProps) {
  return (
    <div
      data-slot="wireframe-drawer-header"
      className={cn(
...
function DrawerFooter({ className, ...props }: DrawerFooterProps) {
  return (
    <div
      data-slot="wireframe-drawer-footer"
 ...
 */
export interface DrawerTitleProps extends React.ComponentProps<
...
function DrawerTitle({ className, ...props }: DrawerTitleProps) {
  return (
    <DrawerPrimitive.Title
      data-slot="wireframe-drawer-title"
 ...
 */
export interface DrawerDescriptionProps extends React.ComponentProps<
...
function DrawerDescription({ className, ...props }: DrawerDescriptionProps) {
  return (
    <DrawerPrimitive.Description
      data-slot="wireframe-drawer-description"
    ...
    <Drawer>
      <DrawerTrigger asChild>
        <Button variant="outline">
          {triggerIcon || (
            <RectangleStackIcon className="text-muted-foreground size-5" />
          )}
          <Text width="sm" />
        </Button>
      </DrawerTrigger>
