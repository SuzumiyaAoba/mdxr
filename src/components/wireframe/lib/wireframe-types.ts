...
export const WIREFRAME_ANIMATIONS = [
  "none",
  "pulse",
  "shimmer",
  "typing",
] as const;
export const WIREFRAME_EMPHASIS = [
  "primary",
  "secondary",
  "tertiary",
  "subtle",
 ...
 */
export interface ResponsiveDimensionProps
  extends ResponsiveSizeProps, ResponsiveWidthProps {}
...
export function isWireframeSize(value: unknown): value is WireframeSize {
  return (
    typeof value === "string" &&
    WIREFRAME_SIZES.includes(value as WireframeSize)
  );
}
...
export function isBreakpoint(value: unknown): value is Breakpoint {
  return (
    typeof value === "string" &&
    ["base", "sm", "md", "lg", "xl"].includes(value)
  );
}
