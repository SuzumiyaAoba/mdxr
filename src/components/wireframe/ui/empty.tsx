...
function EmptyHeader({ className, ...props }: EmptyHeaderProps) {
  return (
    <div
      data-slot="wireframe-empty-header"
      className={cn(
...
function EmptyMedia({
  ...
  return (
    <div
      data-slot="wireframe-empty-icon"
...
function EmptyTitle({ className, ...props }: EmptyTitleProps) {
  return (
    <div
      data-slot="wireframe-empty-title"
...
function EmptyDescription({ className, ...props }: EmptyDescriptionProps) {
  return (
    <div
      data-slot="wireframe-empty-description"
      className={cn(
...
function EmptyContent({ className, ...props }: EmptyContentProps) {
  return (
    <div
      data-slot="wireframe-empty-content"
      className={cn(
