...
import { ChartWireframe } from "../ui/chart.js";
import {
  Table,
  TableBody,
  TableCellWireframe,
      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
        <Card>
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            ...
            <CurrencyDollarIcon className="text-muted-foreground size-6 shrink-0" />
          </CardHeader>
          <CardContent>
            <div className="space-y-1">
        ...
        <Card>
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            ...
            <UsersIcon className="text-muted-foreground size-6 shrink-0" />
          </CardHeader>
          <CardContent>
            <div className="space-y-1">
        ...
        <Card>
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            ...
            <ChartBarIcon className="text-muted-foreground size-6 shrink-0" />
          </CardHeader>
          <CardContent>
            <div className="space-y-1">
              <Text width="md" emphasis="primary" size="xl" />
        ...
        <Card>
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            ...
            <ArrowTrendingUpIcon className="text-muted-foreground size-6 shrink-0" />
          </CardHeader>
          <CardContent>
            <div className="space-y-1">
      ...
      <div className="grid gap-4 lg:grid-cols-7">
        <Card className="overflow-hidden lg:col-span-4">
          ...
          <CardContent className="overflow-x-auto pl-2">
            <ChartWireframe
              variant="bar"
              className="h-[200px] min-w-[300px] lg:h-[300px]"
            />
          </CardContent>
        </Card>
