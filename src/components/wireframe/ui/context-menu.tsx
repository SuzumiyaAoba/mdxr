...
function ContextMenu({ ...props }: ContextMenuProps) {
  return (
    <ContextMenuPrimitive.Root data-slot="wireframe-context-menu" {...props} />
  );
}
...
function ContextMenuTrigger({ ...props }: ContextMenuTriggerProps) {
  return (
    <ContextMenuPrimitive.Trigger
      data-slot="wireframe-context-menu-trigger"
      {...props}
    />
  );
}

export interface ContextMenuGroupProps extends React.ComponentProps<
...
function ContextMenuGroup({ ...props }: ContextMenuGroupProps) {
  return (
    <ContextMenuPrimitive.Group
      data-slot="wireframe-context-menu-group"
      {...props}
    />
  );
}

export interface ContextMenuPortalProps extends React.ComponentProps<
...
function ContextMenuPortal({ ...props }: ContextMenuPortalProps) {
  return (
    <ContextMenuPrimitive.Portal
      data-slot="wireframe-context-menu-portal"
      {...props}
    />
  );
}

export interface ContextMenuSubProps extends React.ComponentProps<
...
function ContextMenuSub({ ...props }: ContextMenuSubProps) {
  return (
    <ContextMenuPrimitive.Sub
      data-slot="wireframe-context-menu-sub"
      {...props}
    />
  );
}

export interface ContextMenuRadioGroupProps extends React.ComponentProps<
...
function ContextMenuRadioGroup({ ...props }: ContextMenuRadioGroupProps) {
  return (
    <ContextMenuPrimitive.RadioGroup
      data-slot="wireframe-context-menu-radio-group"
      {...props}
    />
  );
}
...
function ContextMenuSubTrigger({
  ...
  return (
    <ContextMenuPrimitive.SubTrigger
      data-slot="wireframe-context-menu-sub-trigger"
      data-inset={inset}
      className={cn(
...
export interface ContextMenuSubContentProps extends React.ComponentProps<
...
function ContextMenuSubContent({
  ...
  return (
    <ContextMenuPrimitive.SubContent
      data-slot="wireframe-context-menu-sub-content"
      className={cn(
  ...
  return (
    <ContextMenuPrimitive.Portal>
      <ContextMenuPrimitive.Content
        data-slot="wireframe-context-menu-content"
        className={cn(
...
function ContextMenuItem({
  ...
  return (
    <ContextMenuPrimitive.Item
      data-slot="wireframe-context-menu-item"
      data-inset={inset}
...
function ContextMenuCheckboxItem({
  ...
  return (
    <ContextMenuPrimitive.CheckboxItem
      data-slot="wireframe-context-menu-checkbox-item"
      className={cn(
...
function ContextMenuRadioItem({
  ...
  return (
    <ContextMenuPrimitive.RadioItem
      data-slot="wireframe-context-menu-radio-item"
      className={cn(
        "focus:bg-accent focus:text-accent-foreground relative flex cursor-default items-center gap-2 rounded-sm py-1.5 pr-2 pl-8 text-sm outline-hidden select-none data-disabled:pointer-events-none data-disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4",
        className
      )}
...
function ContextMenuLabel({
  ...
  return (
    <ContextMenuPrimitive.Label
      data-slot="wireframe-context-menu-label"
      data-inset={inset}
      className={cn(
...
function ContextMenuSeparator({
  ...
  return (
    <ContextMenuPrimitive.Separator
      data-slot="wireframe-context-menu-separator"
...
function ContextMenuShortcut({
  ...
  return (
    <span
      data-slot="wireframe-context-menu-shortcut"
      className={cn(
