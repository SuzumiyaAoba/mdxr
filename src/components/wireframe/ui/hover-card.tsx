...
function HoverCard({ ...props }: HoverCardProps) {
  return (
    <HoverCardPrimitive.Root data-slot="wireframe-hover-card" {...props} />
  );
}
...
function HoverCardTrigger({ ...props }: HoverCardTriggerProps) {
  return (
    <HoverCardPrimitive.Trigger
      data-slot="wireframe-hover-card-trigger"
      {...props}
    />
  );
}
...
function HoverCardContent({
  ...
  return (
    <HoverCardPrimitive.Portal data-slot="wireframe-hover-card-portal">
      <HoverCardPrimitive.Content
        data-slot="wireframe-hover-card-content"
        align={align}
    ...
    <HoverCard>
      <HoverCardTrigger asChild>
        <Button variant="outline">
          {triggerIcon || (
            <IdentificationIcon className="text-muted-foreground size-5" />
          )}
          <Text width="xs" />
        </Button>
      </HoverCardTrigger>
