...
function Dialog({ ...props }: DialogProps) {
  return <DialogPrimitive.Root data-slot="wireframe-dialog" {...props} />;
}
...
function DialogTrigger({ ...props }: DialogTriggerProps) {
  return (
    <DialogPrimitive.Trigger data-slot="wireframe-dialog-trigger" {...props} />
  );
}

export interface DialogPortalProps extends React.ComponentProps<
  typeof DialogPrimitive.Portal
> {}

function DialogPortal({ ...props }: DialogPortalProps) {
  return (
    <DialogPrimitive.Portal data-slot="wireframe-dialog-portal" {...props} />
  );
}
...
function DialogClose({ ...props }: DialogCloseProps) {
  return (
    <DialogPrimitive.Close data-slot="wireframe-dialog-close" {...props} />
  );
}
...
function DialogOverlay({ className, ...props }: DialogOverlayProps) {
  return (
    <DialogPrimitive.Overlay
      data-slot="wireframe-dialog-overlay"
      className={cn(
...
function DialogContent({
  ...
  return (
    <DialogPortal data-slot="wireframe-dialog-portal">
      <DialogOverlay />
      <DialogPrimitive.Content
        data-slot="wireframe-dialog-content"
        className={cn(
      ...
      >
        ...
        {showCloseButton && (
          <DialogPrimitive.Close
            data-slot="wireframe-dialog-close"
...
function DialogHeader({ className, ...props }: DialogHeaderProps) {
  return (
    <div
      data-slot="wireframe-dialog-header"
...
function DialogFooter({ className, ...props }: DialogFooterProps) {
  return (
    <div
      data-slot="wireframe-dialog-footer"
      className={cn(
...
function DialogTitle({ className, ...props }: DialogTitleProps) {
  return (
    <DialogPrimitive.Title
      data-slot="wireframe-dialog-title"
 ...
 */
export interface DialogDescriptionProps extends React.ComponentProps<
...
function DialogDescription({ className, ...props }: DialogDescriptionProps) {
  return (
    <DialogPrimitive.Description
      data-slot="wireframe-dialog-description"
    ...
    <Dialog>
      <DialogTrigger asChild>
        <Button variant="outline">
          {triggerIcon || (
            <ChatBubbleLeftEllipsisIcon className="text-muted-foreground size-5" />
          )}
          <Text width="sm" />
        </Button>
      </DialogTrigger>
